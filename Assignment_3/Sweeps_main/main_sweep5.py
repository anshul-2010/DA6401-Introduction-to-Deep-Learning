...
def __main__():
    ...
    # Sweep Configuration 5
    sweep_config5 = {
        "name": "Sweep 5 Attention- Assignment3",
        "description": "Hyperparameter sweep for Seq2Seq Model with Attention",
        "method": "grid",
        "metric": {'name': 'val_acc', 'goal': 'maximize'},
        "parameters": {
                "enc_dec_layers": {"values": [1, 2, 3]},
                "units": {"values": [64, 128, 256]},
                "dropout": {"values": [0.2, 0.3, 0.4]},
                "attention": {"values": [True]}
                }
        }
    sweep_id = wandb.sweep(sweep_config5, project="Enter your project name here")
