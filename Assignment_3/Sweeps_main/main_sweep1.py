...
def __main__():
    ...
    sweep_config1 = {
        ...
        "parameters": {
                "enc_dec_layers": {"values": [1, 2, 3, 4]},
                "units": {"values": [32, 64, 128, 256]},
                "layer_type": {"values": ["lstm", "rnn", "gru"]}
                }
        }
    sweep_id = wandb.sweep(sweep_config1, project="Enter your project name here")
